...
- **Config files carry `$schema` headers** pointing at https://docs.overwire.io/schemas/index.json (per-format URLs inside) — keep them when editing, copy them when adding files.
